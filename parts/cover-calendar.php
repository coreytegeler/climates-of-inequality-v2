	...
	<div id="cover-card" class="container">
		...
		<div class="row">
			...
			<div class="col col-10 col-md-8">
				...
				<header id="cover-header" class="row mb-md">
		...
		if( sizeof( $upcoming_event_arr ) ) {
			...
			<div class="row">
				<div id="cover-content" class="col col-10 col-md-8 blue-bg white-text">
		...
		<div class="row">
			<div class="col col-10 col-md-8 white-bg blue">
				<a href="#content" role="button" id="skip-to-content" class="blue"></a>
			</div>
		</div>
